...
export const getAllVehicles = createAsyncThunk(
    "get/allVehicles",async({page=1, sortBy, search},{rejectWithValue})=>{
        try {
            const config ={
                headers:{
            ...
            const { data } = await axiosInstance.get(`/api/v1/vehicles?page=${page}&sortBy=${sortBy}&search=${search}`,config);
