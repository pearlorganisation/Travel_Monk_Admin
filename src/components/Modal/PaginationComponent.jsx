            ...
            >
                <span className="text-sm font-normal text-gray-500 dark:text-gray-400">
                    ...
                    <span className="font-semibold text-gray-900 dark:text-white ml-2 mr-2">
                        {(paginate?.limit ?? paginate?.pageSize) * (currentPage - 1) + 1} -
                        {Math.min((paginate?.limit ?? paginate?.pageSize) * currentPage, paginate?.count ?? paginate?.total)}
                    </span>
                    of
                ...
                <ul className="inline-flex items-stretch -space-x-px">
                    ...
                    <li>
                        <button
                            ...
                            className={`flex items-center justify-center h-full py-1.5 px-3 leading-tight text-gray-500 bg-white rounded-r-lg border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white ${currentPage === totalPages
