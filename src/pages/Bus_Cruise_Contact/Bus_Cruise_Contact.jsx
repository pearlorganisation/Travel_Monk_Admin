  ...
  if (isError) {
    return (
      <main className="flex-1 p-8 mt-16 ml-64">
        <div className="text-red-500 text-xl font-semibold">No Contact Found</div>
      </main>
    );
  }
  ...
  return (
    <main className="flex-1 p-8 mt-16 ml-64 bg-gray-50">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-4xl font-bold text-gray-800">Bus & Cruise Bookings</h1>
        ...
        <div className="flex space-x-4">
          {cruiseTypes.map((type) => (
            <button
              ...
              className={`flex items-center space-x-2 px-6 py-3 rounded-lg text-lg transition-all duration-300 ${cruiseType.includes(type.type)
      ...
      <div className="grid gap-6">
        {Array.isArray(bus_cruise) && bus_cruise?.map((contact) => (
          <div
            key={contact._id}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-500 font-medium">Number of Seats</p>
                    <p className="font-semibold text-gray-800">{contact.numberOfSeats}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-500 font-medium">Start Destination</p>
                    <p className="font-semibold text-gray-800">{contact.startDestination}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-500 font-medium">End Destination</p>
                    <p className="font-semibold text-gray-800">{contact.endDestination}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-500 font-medium">Booking Date</p>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  <div className={`px-4 py-2 text-sm rounded-lg ${contact.type === 'bus' ? 'bg-green-100 text-green-700' : 'bg-blue-100 text-blue-700'
                    } font-semibold capitalize`}>
                    {contact.type === 'bus' ? '🚌 ' : '🚢 '}{contact.type}
                  </div>
                </div>
